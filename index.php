...
<body>
  <div class="content">
  <h1>AJAX Quotes</h1>
  <p> Explore a cool website that shares different quotes. New quotes pop up every few seconds, and they look really cool with fancy designs on the screen. The background has a nice light blue color. If there's a problem and a quote can't be shown, the website will let you know. It's a fun way to enjoy lots of different quotes, and the page looks really pretty with its moving pictures.</p>
   </div>
